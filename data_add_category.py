...
if __name__=='__main__':
    ...
    # # # 2.1 创建Category数据
    models.Category.objects.all().delete() #删除已有账户
    descriptions=['python基础','python进阶','python高级','python斗圣之路','python寒冰王座']
    objs=[]
    for description in descriptions:
        obj=models.Account(description=description)
        objs.append(obj)
    models.Category.objects.bulk_create(objs, len(objs))  # 一次插入10个，共插入100个账户
